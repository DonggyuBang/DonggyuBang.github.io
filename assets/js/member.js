document.addEventListener('DOMContentLoaded',async()=>{
  ...
  if(!hasResearchInterests){
    metricsEl?.closest('section')?.setAttribute('hidden','');
    pubsEl?.closest('section')?.setAttribute('hidden','');
    return;
  }

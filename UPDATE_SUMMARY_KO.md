# BERL Website Editorial Redesign — 2026-08-29

이번 리뉴얼은 기존 정보구조와 데이터 연동을 유지하면서 디자인 시스템을 전면 재구성한 버전입니다.

- Blue / Navy 중심 editorial visual system
- 대형 타이포그래피와 강한 그리드
- Hero 배경 슬라이드와 Recent News 독립 전환
- 생성형 환경공학 / 바이오에너지 / 미생물 / AI 이미지 활용
- Research carousel 및 scroll-driven motion
- People 직급별 그룹 구조 유지
- OpenAlex 자동 논문/인용 데이터 동기화 유지
- Google Scholar / ORCID 링크 유지
- News 목록 → 상세 기사 구조 유지
